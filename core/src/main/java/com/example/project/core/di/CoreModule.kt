...
import com.example.project.core.data.MovieAppRepository
import com.example.project.core.data.source.local.LocalDataSource
import com.example.project.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("byte".toCharArray())
...
val repositoryModule = module {
    ...
    single<IMovieAppRepository> { MovieAppRepository(get(), get()) }
}